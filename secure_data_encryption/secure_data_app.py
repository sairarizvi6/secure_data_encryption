...
if st.session_state.current_page == "Home":
    ...
    st.write("Safely manage data with unique passkey-based encryption and retrieval")
    ...
    if time.time() - st.session_state.last_attempt_time < 10 and st.session_state.failed_attempts >= 3:
        ...
        if st.button("Login"):
            if login_pass == "Govpia@1234":  # Hardcoded for demo, replace with proper auth
...
# Add a footer
st.markdown("---")
st.markdown("🔐 Secure Data Encryption System | Academic Project | Made By Saira Rizvi ✌")
